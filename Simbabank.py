...
class BankAccount:
    ...
    def __add__(self, other):
        if (self.hero) != (other.hero):
            return "Нельзя складывать счета разных типов героев"
...
acc1 = BankAccount(mage1, 5000, "1234", "Optima")
acc2 = BankAccount(mage2, 3000, "0000", "Optima")
acc3 = BankAccount(warrior, 2500, "1111", "Optima")
print(mage1.action())
